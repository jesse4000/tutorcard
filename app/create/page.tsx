        ...
        <div className="left-panel">
          {!done ? (
                ...
                <div style={{ animation: "stepIn 0.4s ease both" }}>
                  ...
                  <div className="step-nav">
                    ...
                    <button
                      ...
                      disabled={submitting}
                    >
                      {submitting ? "Creating..." : "🎉 Create my card"}
                    </button>
                  </div>
                </div>
              )}
            ...
            <div style={{ animation: "stepIn 0.4s ease both" }}>
              ...
              <div className="done-title">Your card is live!</div>
              <div className="done-sub">
                Share it anywhere — Facebook groups, parent communities, your
                email signature, or just let people scan your QR code.
              </div>
              ...
              <div className="next-steps">
                ...
                <div className="next-step-item" style={{ opacity: 0.5 }}>
                  <span className="nsi-icon">📢</span>
                  <div>
                    <div>Post a referral</div>
                    <div className="nsi-sub">Coming soon!</div>
                  </div>
                  <span className="nsi-arr">→</span>
                </div>
                <div className="next-step-item" style={{ opacity: 0.5 }}>
